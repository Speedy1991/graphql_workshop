...
class StudentType(graphene.ObjectType):
    # TODO 1: Define a custom field "modules" on the StudentType, resolving to a list of ModuleType's
    ...
    # One way to archive this is to add "module_set" to "only_fields" but this will expose a endpoint called "moduleSet"

    # TODO 2: Write a custom resolver for the field defined above
